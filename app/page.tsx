        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {modules.map((module) => (
              ...
              >
                <Card
                  className={`h-full transition-all duration-200 border-2 border-transparent hover:border-gray-200 ${module.color}`}
                >
                  <CardHeader>
                    {module.icon}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <Link
                href="/design-system"
                className="block p-2 hover:bg-gray-100 rounded text-sm text-blue-600"
              >
